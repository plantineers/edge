...
- Terminal approach:
    ```
    $HOME/.espressif/tools/riscv32-esp-elf/esp-2021r2-patch3-8.4.0/riscv32-esp-elf/bin/riscv32-esp-elf-gdb target/xtensa-esp32c3-espidf/debug/edge -ex "target remote localhost:9333"
    ```
