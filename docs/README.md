...
- Terminal approach:
    ```
    $HOME/.espressif/tools/xtensa-esp32c6-elf/esp-2021r2-patch3-8.4.0/xtensa-esp32c6-elf/bin/xtensa-esp32c6-elf-gdb target/xtensa-esp32c6-espidf/debug/edge -ex "target remote localhost:9333"
    ```
